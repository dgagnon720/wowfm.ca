...
<html>
<head>
  <meta property="og:title" content="Gagnez un traitement antirouille complet.">
  <meta property="og:description" content="Concours WOW 97.1 - Gagnez un traitement antirouille complet!">
  <meta property="og:image" content="https://wowfm.ca/images/antirouille-metropolitain-accueil.png">
  <meta property="og:url" content="https://wowfm.ca/concours-antirouille-metropolitain.php">
  <meta name="twitter:card" content="https://wowfm.ca/images/antirouille-metropolitain-accueil.png">
      ...
      <div class="row">
        <div class="col-12">
          <div class="section-title-header text-center">
            <h1 class="section-title fadeInUp">Gagnez un traitement antirouille complet!</h1>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg-8 posts-list">
                  <div class="single-post">
                      <div class="feature-img">
                          <img class="img-fluid" src="images/antirouille-metropolitain-page-concours.png" alt="">
                      </div>

                      <div class="blog_details">
                          <h2>Écoutez WOW 97,1, c’est intelligent et payant pour votre bonheur ...mais, aussi pour votre voiture ! </h2>
                          <!--ul class="blog-info-link mt-3 mb-4">
                              <li><a href="#"><i class="far fa-user"></i> Concours</a></li>
                              <li><a href="#"><i class="far fa-comments"></i> Tout l'été</a></li>
                          </ul-->
                          <p class="excert"> Du 15 au 19 aout, vous pourriez gagner un traitement antirouille complet pour
																												votre véhicule par les experts de chez ANTIROUILLE MÉTROPOLITAIN!</p>
													<p>Au signal sonore en ondes, textez ANTIROUILLE au 819 503 9711 pour vous
																												qualifier ! </p>
													<p>Prenez rendez-vous chez Antirouille Métropolitain dès maintenant! Antirouille
																												Métropolitain, un investissement intelligent et payant. <a href="http://antirouille.com" target="_blank">antirouille.com</a>
																								<p>
