              ...
              <div class="col-lg-8 posts-list">
                  <div class="single-post">
                      ...
                      <div class="blog_details">
                          <h2>
                          				Chaque jour cette semaine, un artiste est mis en vedette ! </h2>
                          <!--ul class="blog-info-link mt-3 mb-4">
                              <li><a href="#"><i class="far fa-user"></i> Concours</a></li>
                              <li><a href="#"><i class="far fa-comments"></i> Tout l'été</a></li>
                          </ul-->
                          <p class="excert"> Et à chaque diffusion d'une de ses chansons, vous devez texter "Pharmaprix" au 819 503 9711 pour vous qualifier pour gagner 500$ chez Pharmaprix!<br>

Du 16 au 21 septembre, c’est l’événement Prime d’échange de points chez Pharmaprix!
