...
<html>
<head>
  <meta property="og:title" content="Vous pourriez gagner 500$ chez Pharmaprix.">
  <meta property="og:description" content="Concours WOW 97.1 - Vous pourriez gagner 500$ chez Pharmaprix!">
  <meta property="og:image" content="https://wowfm.ca/images/pharmaprix-carte-cadeau-500-accueil.png">
  <meta property="og:url" content="https://wowfm.ca/concours-carte-cadeau-pharmaprix.php">
  <meta name="twitter:card" content="https://wowfm.ca/images/pharmaprix-carte-cadeau-500-accueil.png">
      ...
      <div class="row">
        <div class="col-12">
          <div class="section-title-header text-center">
            <h1 class="section-title fadeInUp">Vous pourriez gagner 500$ chez Pharmaprix!</h1>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg-8 posts-list">
                  <div class="single-post">
                      <div class="feature-img">
                          <img class="img-fluid" src="images/pharmaprix-carte-cadeau-500-page-concours.png" alt="">
                      </div>

                      <div class="blog_details">
                          <h2>
                          				Surveillez le Pharma-Mix à tout moment dans la programmation de WOW!  </h2>
                          <!--ul class="blog-info-link mt-3 mb-4">
                              <li><a href="#"><i class="far fa-user"></i> Concours</a></li>
                              <li><a href="#"><i class="far fa-comments"></i> Tout l'été</a></li>
                          </ul-->
                          <p class="excert"> Identifiez un maximum de chansons au 503 9711 par texto.<br>

Vous pourriez gagner 500$ à dépenser chez Pharmaprix!<br>
<br>


Visitez Pharmaprix du 19 au 25 novembre et économisez GROS pendant le SUPER SOLDE du Vendredi fou!  <br>

Téléviseur, parfums, chocolats, jouets : des aubaines exceptionnelles dans tout le magasin ou dans la circulaire de Pharmaprix.  <br><br>

 

Économisez gros. Partez content.  <br>

Des restrictions s'appliquent. Détails en magasin.
																							<p><a href="https://www.pharmaprix.ca" target="_blank">https://www.pharmaprix.ca</a></p>
