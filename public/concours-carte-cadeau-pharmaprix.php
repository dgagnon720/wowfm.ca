...
<html>
<head>
  <meta property="og:title" content="Vous pourriez gagner une des 5 cartes cadeaux de 500$ chez Pharmaprix.">
  <meta property="og:description" content="Concours WOW 97.1 - Gagner une des 5 cartes cadeaux de 500$ chez Pharmaprix!">
      ...
      <div class="row">
        <div class="col-12">
          <div class="section-title-header text-center">
            <h1 class="section-title fadeInUp">Le chiffre chanceux WOW!</h1>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg-8 posts-list">
                  <div class="single-post">
                      ...
                      <div class="blog_details">
                          <h2>
                          				Cette semaine, vous pourriez gagner une des 5 cartes cadeaux de 500$ chez Pharmaprix ! </h2>
                          <!--ul class="blog-info-link mt-3 mb-4">
                              <li><a href="#"><i class="far fa-user"></i> Concours</a></li>
                              <li><a href="#"><i class="far fa-comments"></i> Tout l'été</a></li>
                          </ul-->
                          <p class="excert"> Jusqu'au 26 aout, envoyez-nous un chiffre entre 1 et 97 au signal sonore en ondes au 819 503 9711!</p>
													<p>Le premier auditeur à avoir le chiffre du jour gagnera sa carte cadeau Pharmaprix de 500$ !  </p>
													<p>Profitez de leur grande vente 60e anniversaire, pleins de rabais en magasin !
