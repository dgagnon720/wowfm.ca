...
<html>
<head>
  <meta property="og:title" content="Le plus bel homme de l'Outaouais">
  <meta property="og:description" content="Concours WOW 97.1 - Le plus bel homme de l'Outaouais">
  <meta property="og:image" content="https://wowfm.ca/images/inscrivez-pour-le-plus-bel-homme-2023-affiche.png">
  <meta property="og:url" content="https://wowfm.ca/concours_leplusbelhommedeloutaouais.php">
  <meta name="twitter:card" content="https://wowfm.ca/images/inscrivez-pour-le-plus-bel-homme-2023-affiche.png">
      ...
      <div class="row">
        <div class="col-12">
          <div class="section-title-header text-center">
            <h1 class="section-title fadeInUp">Le plus bel homme de l'Outaouais</h1>
          </div>
        </div>
      </div>
              ...
              <div class="col-lg-8 posts-list">
                  <div class="single-post">
                      <div class="feature-img">
                          <img class="img-fluid" src="images/inscrivez-pour-le-plus-bel-homme-2023-affiche.png" alt="">
                      </div>

                      <div class="blog_details">
                          <h2>Le plus bel homme de l'Outaouais</h2>
                          <ul class="blog-info-link mt-3 mb-4">
                              <li><a href="#"><i class="far fa-user"></i> Concours</a></li>
                              <li><a href="#"><i class="far fa-comments"></i> Le plus bel homme de l'Outaouais</a></li>
                          </ul>
                          <p class="excert">
                          Inscriptions ouvertes à partir du 27 février 2023 jusqu'au 24 mars 2023, 23h59<p>
				<a href="./docs/Reglements-plus-bel-homme_de-l-Outaouais.pdf">Cliquez ici pour les règlements du concours</a><p>
                            <!-- form.123formbuilder.com script begins here -->
			<!--	<script type="text/javascript" defer src="https://form.123formbuilder.com/embed/6092968.js" data-role="form" data-default-width="650px"></script> -->
				Les inscription sont terminées.<br>
				<h2>
				<a href="./concours_leplusbelhommedeloutaouais_finalistes.php">Vous pouvez voter pour les finalistes ici</a> <br>
				</h2>
			    <!-- form.123formbuilder.com script ends here -->
                          <a href="./docs/Reglements-plus-bel-homme_de-l-Outaouais.pdf">Cliquez ici pour les règlements</a>
		      </div>
