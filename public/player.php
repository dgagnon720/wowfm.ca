...
if ($time >= "1300" && $time < "1600" && $jour >= "1" && $jour <= "5") {
  $show = "Au travail, c'est Wow";
  $horaire = "En semaine - 13h00 à 16h00";
      if ($jour == "5") {
          $nextshow = "Le 3 à 7";
        } else {
...
if ($time >= "1600" && $time < "1800" && $jour >= "1" && $jour <= "4") {
  $show = "Chéri, j'arrive!";
  $horaire = "En semaine - 16h00 à 18h00";
  $nextshow = "Wow 97.1";
  $image = "valerieCormier.jpg";
} else
    ...
    <div class="row">
      ...
      <div class="col-8 text-white">
          <div style="margin-top:15px; margin-left:5px;">
            ...
            <span class="font-weight-light text-muted"><?php echo $horaire; ?></span><br>
            <span class="font-weight-light text-muted" style="text-decoration: underline;">À venir: </span><span class="font-weight-medium text-muted"><?php echo $nextshow; ?></span><p>
              <span style="font-size: 8pt;" class="font-weight-light text-muted"><?php echo $fulljour; echo " - "; echo $fulldate; ?></span><br>
              <!--<span class="font-weight-bold text-white">Dark Horse</span><br>
              <span class="font-weight-light text-white">Katy Perry</span> -->
          </div>
      </div>
